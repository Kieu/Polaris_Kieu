class PromotionsController < ApplicationController
  ...
  def index
    ...
    f.xAxis(:type => 'date', :dateTimeLabelFormats => {day: '%e. %b',
            month: '%e. %b'}, :categories => aryCategory,
            :labels => {rotation: -45, :style => {:color => '#6D869F',
  ...
  def must_delete_able
    ...
    redirect_to promotions_path if @promotion.nil? || @promotion.del_flg == 1
  end
end
